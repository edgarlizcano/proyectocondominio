 ...
 * @author Edgar
 */
public class ADOCasas {
    //Metodo utilizado para insertar un Usuario a nuestra Base de datos
    public static synchronized boolean insertarCasas(Casas c) {
        Connection cn = null;
    ...
    public static synchronized ArrayList<Casas> obtenerCasas() {
