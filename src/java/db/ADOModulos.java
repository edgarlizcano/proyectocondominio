 ...
 * @author Edgar
 */
public class ADOModulos {
    //Metodo utilizado para insertar un Usuario a nuestra Base de datos
    public static synchronized boolean insertarModulo(Modulos m) {
        Connection cn = null;
    ...
    public static synchronized ArrayList<Modulos> obtenerModulos() {
        ...
        try {
            ...
            String call = "{CALL obtenerModulos()}";
