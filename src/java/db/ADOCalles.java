 ...
 * @author Edgar
 */
public class ADOCalles {
    //Metodo utilizado para insertar un Usuario a nuestra Base de datos
    public static synchronized boolean insertarCalles(Calles c) {
        Connection cn = null;
    ...
    public static synchronized ArrayList<Calles> obtenerCalles() {
        //El array que contendra todos nuestros productos
        ArrayList<Calles> lista = new ArrayList<>();
        Connection cn = null;
        CallableStatement cl = null;
        ResultSet rs;
        try {
            //Nombre del procedimiento almacenado
            String call = "{CALL obtenerCalles()}";
            ...
            while (rs.next()) {
                ...
                c.setIdCalles(rs.getInt("idCalles"));
                c.setNombreCalle(rs.getString("nombreCalle"));
